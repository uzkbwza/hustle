...
const MIN_COMBO_DAMAGE_PER_BAR = 5
...
func _enter():
	...
	hitbox.minimum_damage = MIN_DAMAGE_PER_BAR * host.kill_process_super_level if host.combo_count > 0 else MIN_COMBO_DAMAGE_PER_BAR
